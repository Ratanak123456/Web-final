    ...
    <section className="py-32 px-6 bg-[var(--bg-primary)]">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="space-y-8 text-xl md:text-2xl leading-relaxed text-[var(--text-secondary)]"
        >
          <p>
            It started with a simple idea: <strong className="text-[var(--accent)]">what if everyone had a platform to share their unique story?</strong>
          </p>
          <p>
          ...
          <p className="text-2xl md:text-3xl font-bold text-[var(--text-primary)] mt-12">
